...
export const mockTickets: Ticket[] = [
  { id: "TK-1042", group: "ลูกค้า VIP", admin: "สมชาย ใจดี", adminOnline: true, tag: "สินค้าชำรุด", urgency: "HIGH", status: "RECEIVED", createdAt: "2026-06-20T09:12:00+07:00" },
  ...
  { id: "TK-1035", group: "ตัวแทนจำหน่าย", admin: "กมล เจริญสุข", adminOnline: true, tag: "ขอสมัครตัวแทน", urgency: "NORMAL", status: "RECEIVED", createdAt: "2026-06-19T10:05:00+07:00" },
